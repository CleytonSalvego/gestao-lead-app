...
import { ArmadilhaRespostaStatusFeromonioEnum } from 'src/app/enums/armadilha-respostas.enum';
...
@Component({
  selector: 'app-apontamento-armadilha-feromonio',
  templateUrl: './apontamento-armadilha-feromonio.page.html',
  styleUrls: ['./apontamento-armadilha-feromonio.page.scss'],
  standalone: true,
  imports:[
    HeaderComponent,
    NgIf,
...
export class ApontamentoArmadilhaFeromonioPage implements OnInit {
  ...
  async loadComboStatusArmadilha(){
    for (const tl of this.enumKeys(ArmadilhaRespostaStatusFeromonioEnum)) {
      var item: ComboInterface ={
          codigo: tl,
          descricao: ArmadilhaRespostaStatusFeromonioEnum[tl]
      }
